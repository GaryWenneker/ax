...
**Current release: [v2.0.12](https://github.com/GaryWenneker/ax/releases/tag/v2.0.12)** — six-platform binaries (Windows, macOS, Linux/WSL2).
...
bash scripts/publish-getax-releases.sh v2.0.12
```
