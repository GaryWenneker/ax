---
title: Get Started
description: Get up and running with ax v4.7.0 in seconds.
---

Install **ax v4.7.0** (or newer from [latest.txt](https://getax.wenneker.io/releases/latest.txt)) — knowledge graph, memory vault, policy engine, MCP Logging / Quality, and Command Center in one binary.
