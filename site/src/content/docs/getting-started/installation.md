---
title: Installation
description: Install ax v4.8.0 and configure your AI coding agents.
---

## Current version

**Latest release: v4.8.0** — install scripts and `ax upgrade` resolve the tag from [getax.wenneker.io/releases/latest.txt](https://getax.wenneker.io/releases/latest.txt). Check your install:
...
Pin a specific release with `AX_VERSION=v4.8.0` when running `install.sh` / `install.ps1`.
