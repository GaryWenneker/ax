...
pub static STACKS: &[StackDef] = &[
    StackDef { id: "dotnet", version: "1.1.0", description: ".NET and C# review rules", depends_on: &[], files: DOTNET_FILES },
    StackDef { id: "java", version: "1.1.0", description: "Java, Maven, and Gradle review rules", depends_on: &[], files: JAVA_FILES },
    StackDef { id: "react", version: "1.1.0", description: "React component and state rules", depends_on: &[], files: REACT_FILES },
    StackDef { id: "nextjs", version: "1.1.0", description: "Next.js App Router rules", depends_on: &["react"], files: NEXTJS_FILES },
    StackDef { id: "angular", version: "1.1.0", description: "Angular dependency injection and template rules", depends_on: &[], files: ANGULAR_FILES },
    StackDef { id: "vue", version: "1.1.0", description: "Vue composition API and single-file component rules", depends_on: &[], files: VUE_FILES },
    StackDef { id: "php", version: "1.1.0", description: "PHP type and security rules", depends_on: &[], files: PHP_FILES },
    StackDef { id: "laravel", version: "1.1.0", description: "Laravel Eloquent and validation rules", depends_on: &["php"], files: LARAVEL_FILES },
    StackDef { id: "drupal", version: "1.1.0", description: "Drupal hook and configuration rules", depends_on: &["php"], files: DRUPAL_FILES },
    StackDef { id: "sitecore", version: "1.1.0", description: "Sitecore Helix and serialization rules", depends_on: &["dotnet"], files: SITECORE_FILES },
    StackDef { id: "optimizely", version: "1.1.0", description: "Optimizely content and initialization rules", depends_on: &["dotnet"], files: OPTIMIZELY_FILES },
    StackDef { id: "astro", version: "1.1.0", description: "Astro islands and content", depends_on: &[], files: ASTRO_FILES },
    StackDef { id: "c", version: "1.1.0", description: "C memory, headers, and errors", depends_on: &[], files: C_FILES },
    StackDef { id: "cpp", version: "1.1.0", description: "C++ ownership, RAII, and errors", depends_on: &[], files: CPP_FILES },
    StackDef { id: "dart", version: "1.1.0", description: "Dart null-safety and widgets or libraries", depends_on: &[], files: DART_FILES },
    StackDef { id: "go", version: "1.1.0", description: "Go errors, packages, and tests", depends_on: &[], files: GO_FILES },
    StackDef { id: "javascript", version: "1.1.0", description: "JavaScript modules and runtime checks", depends_on: &[], files: JAVASCRIPT_FILES },
    StackDef { id: "kotlin", version: "1.1.0", description: "Kotlin null-safety, coroutines, and tests", depends_on: &[], files: KOTLIN_FILES },
    StackDef { id: "lua", version: "1.1.0", description: "Lua modules and errors", depends_on: &[], files: LUA_FILES },
    StackDef { id: "luau", version: "1.1.0", description: "Luau types and modules", depends_on: &[], files: LUAU_FILES },
    StackDef { id: "objc", version: "1.1.0", description: "Objective-C memory and nullability", depends_on: &[], files: OBJC_FILES },
    StackDef { id: "pascal", version: "1.1.0", description: "Pascal units, types, and memory", depends_on: &[], files: PASCAL_FILES },
    StackDef { id: "python", version: "1.1.0", description: "Python types, packaging, and tests", depends_on: &[], files: PYTHON_FILES },
    StackDef { id: "r", version: "1.1.0", description: "R functions, vectors, and packages", depends_on: &[], files: R_FILES },
    StackDef { id: "ruby", version: "1.1.0", description: "Ruby style, gems, and tests", depends_on: &[], files: RUBY_FILES },
    StackDef { id: "rust", version: "1.1.0", description: "Rust ownership, errors, and tests", depends_on: &[], files: RUST_FILES },
    StackDef { id: "scala", version: "1.1.0", description: "Scala types, immutability, and tests", depends_on: &[], files: SCALA_FILES },
    StackDef { id: "svelte", version: "1.1.0", description: "Svelte components and stores", depends_on: &[], files: SVELTE_FILES },
    StackDef { id: "swift", version: "1.1.0", description: "Swift optionals, value types, and tests", depends_on: &[], files: SWIFT_FILES },
    StackDef { id: "typescript", version: "1.1.0", description: "TypeScript types and modules", depends_on: &[], files: TYPESCRIPT_FILES },
];
